...
//        ---------------------
        ...
        sp.setSpan(new ImageSpan(this, android.R.drawable.btn_star_big_off), 6, 7, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        sp.setSpan(new ImageSpan(this, android.R.drawable.btn_star_big_on), 7, 8, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        //設置超連結
        sp.setSpan( new URLSpan("https://www.google.com.tw"), 10, 16, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        //設置TextView可點擊URL
        ...
        //設置斜體
        sp.setSpan( new StyleSpan(Typeface.ITALIC), 41, 43, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        t001.setText(sp);
    }

    @Override
    public void onClick(View v) {
        Toast.makeText(getApplicationContext(), "請吃吐司", Toast.LENGTH_SHORT).show();
    }
}